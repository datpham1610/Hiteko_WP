...
<?php get_header(); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="list-inline text-center tab-title">
                            <li class="list-inline-item active" data-show-id="1" id='tab-internal-1'>LESSON LEARN</li>
                    ...
                    <div class="col-md-12 tab-content" id='content-2'>
                        ...
                        <div class="employee-name">
                            Họ Và Tên / Full Name: <span><?php echo $current_user->display_name; ?></span>
                        </div>
                        <div class="employee-position">
                            Bộ Phận / Department: <span><?php the_field('department','user_'.$current_user->ID) ?></span>
                        </div>
                        <div class="employee-position">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row filter">
                                    <div class="col-xl-2 col-lg-3 pr-md-0 col-md-3">
                                        <label>Tiến độ :</label>
                                    </div>
                                    <div class="col-xl-5 col-lg-6 px-lg-0 col-md-7 ">
                                        <select id="complete-or-not" class="add-complete utm-b">
                                            <option value="1">Đã hoàn thành</option>
                                            <option value="2" selected>Chưa hoàn thành</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-3 col-md-5 pl-lg-0">
                        ...
                        <div class="todolist user" id="todolist">
                            <table class="table table-hover text-center daily-to-do-list d-md-table table-responsive">
                                <thead>
                                    <tr class="">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="edit user d-inline-block" data-id="<?php echo get_the_ID(); ?>">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                            </div>
                                            <div class="delete user d-inline-block" data-delete-id="<?php echo get_the_ID(); ?>">
    ...
    <div class="modal fade user" id="addmodal">
        <div class="modal-dialog modal-lg d-flex flex-column justify-content-center">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header ">
                    <h4 class="modal-title ml-auto mr-auto">ADD NEW TASK</h4>
                </div>
                <!-- Modal body -->
    ...
    <div class="modal fade user" id="editmodal">
        <div class="modal-dialog modal-lg d-flex flex-column justify-content-center">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header ">
    ...
    <div class="modal fade user" id="deletemodal">
